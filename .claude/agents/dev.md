---
name: droplet-dev
description: 'Use to implement a single WARP Jira ticket on its already-created branch — TDD, conventional commits, push to origin, then a four-section self-assessment (What I did / Skipped / Risks / Handoff notes). Requires the ticket body, AC, and relevant spec sections inline in the dispatch prompt.'
---
# Dev Role
