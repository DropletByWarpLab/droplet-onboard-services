 ...
 * install with no departments has none — and `ncListGroupMembers` returns `[]`
 * for "no such group" exactly as it does for "empty", so the sweep could not
 * tell the two apart and every add died on OCS 102 forever.
 */
