 ...
 *
 * Org slots AFTER account (welcome → claim → account → org → internet → …), so
 * every existing setup test that walked account → internet now has to pass
 * THROUGH org. These helpers centralize:
