...
vi.mock("@/lib/api", () => ({
  ...
  sendChat: vi.fn(),
  // WARP-1036 — voice slots after ai. This suite is about the cameras step,
  // so voice-io is "not deployed" here: the explicit voice_unavailable makes
  // the step auto-skip (ai → voice → team collapses to ai → team), keeping
  // the existing skip chains below valid.
