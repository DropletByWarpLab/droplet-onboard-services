    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-separator">
          <h3 className="type-headline text-label-primary">Pair a new device</h3>
          <button
            onClick={onClose}
        ...
        {step === "waiting" && pairing && (
          <div className="p-5 space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={handleCopy}
                className="p-2 rounded-sm bg-accent/10 text-accent hover:bg-accent/20 transition-colors"
                title="Copy link"
              >
