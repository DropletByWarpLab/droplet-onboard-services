...
// Mobile bottom tab bar — capped at 4 + a "More" trigger. The redesign
// also caps at 5 surfaces; we mirror that. Files swaps for Cameras in
// Business workspaces (cameras are more central there) — Phase 1 keeps
// the legacy 4 hrefs; Phase 2 will branch this on `workspace`.
