 ...
 * household Wi-Fi control has TWO mounts whose outlines differ:
 *
 ...
 * and it must reach BOTH branches of the household slot (`WifiSettingsForm` on
 ...
 * `HouseholdWifiCard` imports the other two — declaring it in either of them
