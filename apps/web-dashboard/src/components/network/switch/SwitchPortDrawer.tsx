...
function Fact({ k, children }: { k: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-3 py-2.5 border-t border-separator first:border-t-0 type-footnote">
      <span className="w-24 flex-none text-label-tertiary type-caption-1">{k}</span>
      <span className="flex items-center min-w-0 text-label-primary">{children}</span>
    </div>
  );
}
      ...
      <div className="p-[18px]">
        ...
        <div className="flex items-center gap-3 pb-3.5 border-b border-separator mb-3.5">
          ...
          <div className="flex-1 min-w-0">
            <h2 id={headingId} className="type-subheadline font-semibold text-label-primary truncate">
              {name}
            </h2>
            <div className="type-caption-1 text-label-tertiary mt-px font-mono">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="p-1 text-label-secondary hover:text-label-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 rounded-sm"
          >
        ...
        <div className="flex flex-col mb-[18px]">
          ...
          <Fact k="Role">
            <span className="inline-flex items-center gap-1.5 type-caption-2 text-label-secondary bg-surface-secondary px-2.5 py-1 rounded-full">
          ...
          {port.poe && poeDelivering && (
            <Fact k="Draw">
              <span className="flex items-center flex-1 min-w-0">
                <span className="block h-1 w-[120px] flex-none bg-surface-secondary rounded-full overflow-hidden mr-2">
          ...
          {isProtected && (
            <Fact k="Protected">
              <span className="inline-flex items-center gap-1 type-caption-2 text-accent bg-accent-subtle px-2 py-0.5 rounded-full">
                <ShieldCheck size={10} aria-hidden="true" />
        ...
        {canWrite && (
          <>
            <p className="type-caption-1 font-semibold uppercase tracking-wider text-label-tertiary mb-2.5">
              Admin actions
            </p>
            {isProtected ? (
              <div className="flex gap-2 items-start p-3 bg-surface-secondary rounded-[10px] type-caption-1 leading-relaxed text-label-tertiary">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 p-3 border border-separator rounded-[10px] bg-surface-primary text-left w-full transition-all duration-150 hover:not-disabled:border-accent/40 hover:not-disabled:bg-accent-subtle disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40"
                >
                  <span className="w-[30px] h-[30px] rounded-lg bg-surface-secondary flex items-center justify-center flex-none text-label-secondary">
                    <Tag size={14} aria-hidden="true" />
                  </span>
                  <span className="flex-1 min-w-0">
                    <span className="block type-footnote font-medium text-label-primary">Change VLAN</span>
                    <span className="block type-caption-2 text-label-tertiary mt-px">
        ...
        <div className="flex gap-2 items-center mt-4 pt-3 border-t border-separator type-caption-2 text-label-tertiary">
