...
- **§2 and §5 apply to desktop-hosted and extension servers** — [ADR-056 §D](ADR-056-agentic-extensibility.md) (2026-09-19) generalises both: the classification record is WARP-2426's, the default is `write + confirm` for every source, and no source's self-description is read.
