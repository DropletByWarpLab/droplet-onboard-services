...
| `BUSINESS_PROFILE_REVIEW_DAYS` | WARP-1122 — the review window in days (default `90`). A dismissed nudge only re-arms once the dismissal itself is older than a full window (never resurrects within the same review period). |
