...
- **Prompt-injection hardening** (`services/ai-gateway/middleware/`, `services/ai-gateway/schemas.py`): middleware and tools directories exist but coverage is not documented. GTM M2.7 is `[~]` — verify.
