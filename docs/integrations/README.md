...
>
> **Per-vendor customer setup guides (cloud/SaaS/REST):** [`stripe.md`](stripe.md) · [`hubspot.md`](hubspot.md) · [`mailchimp.md`](mailchimp.md) · [`shopify.md`](shopify.md) · [`xero.md`](xero.md) · [`brevo.md`](brevo.md) · [`klaviyo.md`](klaviyo.md) · [`pipedrive.md`](pipedrive.md) · [`square.md`](square.md) · [`calcom.md`](calcom.md) · [`github.md`](github.md) · [`atlassian.md`](atlassian.md).
>
