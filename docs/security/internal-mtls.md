...
|---|---|---|
| `orchestrator` | `readwrite droplet/#`, `read frigate/#`, `read email/#` | publishes `droplet/files/<user>/*`, `droplet/devices/<user>/*`, `droplet/notifications/<user>`, `droplet/chat/<user>/*`, `droplet/device/state`, `droplet/transcription/run-one`; subscribes the same trees plus `frigate/events`, `frigate/+/status/detect`, `frigate/available`, `droplet/cameras/discovered`, `droplet/index/+/*`; `email/#` is pre-granted for the dashboard email-refresh bridge |
