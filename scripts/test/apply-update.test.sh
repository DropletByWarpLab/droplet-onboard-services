...
EXPECTED_SUBCOMMANDS=" current-image-refs snapshot pull-images stage-configs migrate-deploy recreate-services restore-configs recreate-self-detached list-self-swap-helpers capture-self-swap-logs rm-self-swap-helper *"
DISPATCH_LABELS=""
DISPATCH_SHAPE_OK=1
in_case=0
